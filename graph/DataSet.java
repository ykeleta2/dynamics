 ...
 *  class for plotting 2D graphs.<br>
 *
...
*********************/
   ...
   * @param w Data window
   */
   // MCC change 3/19/97 to plot from previous point
...
//    will be called before any data has been placed in the class.
          if( data == null || data.length < 2 
              ||(length - previousPointLines) < 3) return;  //MCC 7/9/96
...
//    Is the first point inside the drawing region ?
          ...
          for(i=firstPoint+2; i<newLength; i+=2) {        //MCC 7/9/96
