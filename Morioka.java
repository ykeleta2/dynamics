...
public class Morioka extends dynamicGraph {
/** number of curves */
      int ncurve=-1;                       
...
/** evolving time */      
      double t=0.;
/** evolving variables */        
      double[] x={0.1,0.1,0.,0.,0.,0.,0.,0.};  
/** starting values of x */      
      double[] x0={0.01,0.01,0.,0.,0.,0.,0.,0.};   
...
/** GUI items */      
      ...
      private ode solver;    
/** parent */
      private startMorioka outerparent;  
...
*/ 
        ...
        choices = new choiceControls((dynamicGraph) this,  choiceLabels);
...
//*********************************************************************       
      public double[] derivs(double[] x, double t, int n){
           ...
           rhs[0]=1.;
           rhs[1]=x[2];
           rhs[2]=x[1]-a*x[2]-x[1]*x[3]+c;
           rhs[3]=-b*x[3]+x[1]*x[1];
           rhs[4]=1.;
           rhs[5]=x[6];
           rhs[6]=x[5]-a*x[6]-x[5]*x[7]+c;
           rhs[7]=-b*x[7]+x[5]*x[5];
           return rhs;
     }
...
//********************************************************************      
      public void updateParameters() {
            ...
            graph.setTitle("Lorenz Attractor in Shimizu Morioka systems");
