...
import java.util.*;
/**                    
* Iterates and plots the Lorenz model <br> 
* Uses the "Java Graph Class Library" by Leigh Brookshaw
* @version 3 August, 1997
* @author Michael Cross
*/

public class Lorenz extends dynamicGraph {
/** number of curves */
      int ncurve=-1;                       
...
//********************************************************************      
      public void updateParameters() {
            ...
            graph.setTitle("Lorenz Attractor");
